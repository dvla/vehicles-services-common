...
class JsonFormatsSpec extends WordSpec with Matchers {
  ...
  "JsonFormats" should {
    ...
    "successfully unmarshall a valid json vehicle lookup request payload into a request object" in {
      ...
      val expectedRequest = VehicleLookupRequest(DocumentReferenceNumber("12345678901"), VehicleRegistrationMark("WV54XKW"), "testTrackingId")
      val jsonPayload = """{"referenceNumber":"12345678901","registrationNumber":"WV54XKW","trackingId":"testTrackingId"}"""
